...
<template>
  ...
  <h4>2) Options API</h4>
  <OptionComponent1></OptionComponent1>
  <OptionComponent2></OptionComponent2>
  <OptionComponent3></OptionComponent3>
  <OptionComponent4></OptionComponent4>

  <h4>3) 컴포넌트 통신</h4>
  <PropsComponent1 name="김유신" age="25"></PropsComponent1>
  <ul>
    <PropsComponent2 v-for="city in cities" :mycity="city"></PropsComponent2>
  </ul>

  <PropsComponent3 c3Name="홍길동" c3Age="12"></PropsComponent3>
  <EmitComponent1
    name="홍길동"
    age="12"
    v-on:myEmit="emitHanlder"
  ></EmitComponent1>

  <h4>4) 컴포넌트 생명주기</h4>
  <LifeComponent v-if="isShow"></LifeComponent>
